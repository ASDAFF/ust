...
(function ($, document, window, navigator) {
    ...
    var methods = {
        init: function (options) {
            ...
            var doubleHTML = '<span class="irs-diapason-left"></span><span class="irs-diapason"></span><span class="irs-diapason-right"></span>';
            ...
            return this.each(function () {
                ...
                if (isNumber(min)) {
                    ...
                    /*
                     if(settings.min>0)
                     settings.min = Math.ceil(settings.min);
                     else
                ...
                if (isNumber(max)) {
                    ...
                    /*
                     if(settings.max>0)
                     settings.max = Math.ceil(settings.max);
                     else
                ...
                var placeHTML = function () {
                    ...
                    if (sliderIsActive == false) {
                        $fieldTo.css("display", "none  !important");
                        $fieldFrom.hide();
                    ...
                    if (settings.type === "single") {
                        ...
                        $diapason_left = $rangeSlider.find(".irs-diapason-left");
                        $diapason_right = $rangeSlider.find(".irs-diapason-right");
                        setDiapason();
                ...
                var setDiapason = function () {
                    ...
                    $diapason_left[0].style.left = "0px";
                    $diapason_left[0].style.width = x + "px";

                    $diapason_right[0].style.left = (w + x) + "px";
                    if ((normalWidth - w - x) > 0)
                        $diapason_right[0].style.width = (normalWidth - w - x) + "px";
                    else
                        $diapason_right[0].style.width = "0px";
                };
                ...
                var getNumbers = function () {
                    ...
                    if (settings.type === "single") {
                        ...
                        nums.fromPers = nums.fromX / fullWidth * 100;
                        _from = (diapason * nums.fromPers) / 100 + settings.min;
                        nums.fromNumber = _from; //Math.round(_from / settings.step) * settings.step;

                        nums.toX = Math.round($.data($toSlider[0], "x") || parseInt($toSlider[0].style.left, 10) || $toSlider.position().left);

                        nums.toPers = nums.toX / fullWidth * 100;
                        
                        _to = (diapason * nums.toPers) / 100 + settings.min;
                        nums.toNumber = _to; //Math.round(_to / settings.step) * settings.step;
                        ...
                        if (stepFloat) {
                            ...
                            nums.fromNumber = parseInt(nums.fromNumber * settings.step, 10) / settings.step;
                            nums.toNumber = parseInt(nums.toNumber * settings.step, 10) / settings.step;
                        }
                ...
                var setFields = function () {
                    ...
                    if (typeof settings.onLoad === "function" && !sliderIsActive && firstStart) {
                        settings.onLoad.call(this, numbers, slider);
                    }
                };
                ...
                var setRange = function (duration) {
                    ...
                    if (!isNumber(diaposonMin)) {
                        diaposonMin = min;
                    }
                    else
                        diaposonMin = parseFloat(diaposonMin);

                    if (!isNumber(diaposonMax)) {
                        diaposonMax = max;
                    }
                    else
                ...
                var setGrid = function () {
                    ...
                    for (i = 0; i <= bigNum; i += 1) {
                        ...
                        if (i === 0) {
                            ...
                            // gridHTML += '<span class="irs-grid-text" style="left: ' + tStep + 'px; text-align: left;"> < </span>';
                        } else if (i === bigNum) {
                            tStep = step - 100;
                            gridHTML += '<span class="irs-grid-text" style="left: ' + tStep + 'px; text-align: right;">' + text + '</span>';
                            // gridHTML += '<span class="irs-grid-text" style="left: ' + tStep + 'px; text-align: right;"> > </span>';
                        } else {
                            tStep = step - 50;
