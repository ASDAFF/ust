...
<script type="text/javascript">
	BX.addCustomEvent("onPullEvent", function(module_id, command, params) { if (module_id == "unicomments" && params["ENTITY_XML_ID"] == '<?=$arParams["ENTITY_XML_ID"]?>') { BX.show(BX('blg-comment-<?=$arParams["ID"]?>')); } } );
</script>
	<? }
