	...
	if ($arParams['AUTOSAVE'])
		...
		$APPLICATION->IncludeComponent("bitrix:main.post.form", "",
			Array(
				...
				"UPLOAD_FILE" => (isset($arResult["UF_PROPERIES"]["UF_FORUM_MESSAGE_DOC"]) || $arParams["ALLOW_UPLOAD"]=="N" ? false :
					array(
						"INPUT_NAME" => 'FILE_NEW',
						"INPUT_VALUE" => array(),
				...
				"UPLOAD_WEBDAV_ELEMENT" => $arResult["UF_PROPERIES"]["UF_FORUM_MESSAGE_DOC"],
