			...
			?>">
				...
				)
				{
					?><div class="feed-post-text-block feed-info-block"><?
						?><div class="feed-post-text-block-inner"><div class="feed-post-text-block-inner-inner"><?
					...
					foreach($arEvent["COMMENTS"] as $arComment)
					{
						...
						$arRecords[$commentId] = array(
							...
							"NEW" => ($GLOBALS["USER"]->IsAuthorized()
									...
									&& ($arResult["COUNTER_TYPE"] == "**" || $arResult["COUNTER_TYPE"] == "blog_post") ? "Y" : "N"),
							"AUTHOR" => array(
...
//							"UF" => $arComment["UF"]
				...
				if ($diff > 0)
				{
					...
					?><script type="text/javascript">BX.ready(function(){ __logCommentsListRedefine("<?=$entity_xml_id?>");});</script><?
