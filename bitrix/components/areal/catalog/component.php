...
if($arParams["SEF_MODE"] == "Y")
{
	...
	if($componentPage == "element" && isset($arResult["VARIABLES"]["ELEMENT_CODE"]) && strpos($arResult["VARIABLES"]["ELEMENT_CODE"], "brand_") !== false) {
		$arResult["VARIABLES"]["BRAND_CODE"] = substr($arResult["VARIABLES"]["ELEMENT_CODE"], strlen("brand_"), strlen($arResult["VARIABLES"]["ELEMENT_CODE"]));
		$componentPage = "brand";
	}
}
else
