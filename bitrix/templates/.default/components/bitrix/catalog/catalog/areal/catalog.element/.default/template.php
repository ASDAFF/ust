	...
	<div class="ppic detail">
		<div class="image-main image">
			<?if(count($arResult["PHOTOS"])>0):?>
				<a rel="gal1" class="fancybox" href="<?=$arResult["PHOTOS"][0]["NATURE"]?>" >
			<?endif;?>
					<table><tr><td>
						<?if(!empty($arResult["PHOTOS"][0]["STANDART"]["src"])):?>
							<img class="photo" src="<?=$arResult["PHOTOS"][0]["STANDART"]["src"]?>" width="<?=$arResult["PHOTOS"][0]["STANDART"]["width"]?>" height="<?=$arResult["PHOTOS"][0]["STANDART"]["height"]?>" alt="<?=$arResult["NAME"]?>" title="<?=$arResult["NAME"]?>" />
						<?else:?>
