                ...
                <div class="kombox-combo" data-name="<?=$arResult["ITEMS"]["1350"]["CODE_ALT"]?>" style="float:right;  padding: 0;">                
                    <ul>
                        ...
                        <li class="li_checkbox <?echo $ar["DISABLED"]? 'kombox-disabled ': ''?><?echo $ar["CHECKED"]? 'kombox-checked': ''?>">                               
                            ...
                            <label for="<?=$ar["CONTROL_ID"]?>" class="label_checked checkbox_off" style="padding-right:9px;"><font style="padding-top: 8px;"><?echo $ar["VALUE"];?></font> <span style="padding-top: 8px; display: none;">(<?echo $arResult["section_filter"]["CNT"];?>)</span></label>
                            <?else:?>
                            <label for="<?=$ar["CONTROL_ID"]?>" class="label_checked checkbox_off" style="padding-right:9px;"><font style="padding-top: 8px;"><?echo $ar["VALUE"];?></font> <span style="padding-top: 8px; display: none;">(<?echo $ar["CNT"];?>)</span></label>
                            <?endif?>
                        </li>
                        <?endforeach;?>
                    </ul> 
